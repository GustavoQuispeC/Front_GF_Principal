  ...
  const Card = ({ title, img, description }: CardProps) => (
    <button
      ...
      className={[
        ...
        "hover:-translate-y-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500",
        "shrink-0",
    ...
    >
      ...
      {/* Contenido inferior */}
      <div className="h-1/3 p-4 flex flex-col justify-between bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-850">
        <div>
          <div className="font-bold tracking-tight text-blue-900 dark:text-white text-base sm:text-lg line-clamp-2 mb-1">
            {title}
          </div>
        ...
        {/* CTA con icono */}
        <div className="flex items-center gap-1.5 text-orange-600 dark:text-orange-500 text-md font-medium mt-2 group-hover:gap-2.5 transition-all duration-300">
          <span>Explorar</span>
      ...
      {/* Borde hover */}
      <div className="absolute inset-0 rounded-xl ring-2 ring-orange-500/0 group-hover:ring-orange-500/20 dark:group-hover:ring-orange-400/20 transition-all duration-300 pointer-events-none" />
    </button>
  );
