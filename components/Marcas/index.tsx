    ...
    return (
      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="max-w-3xl mb-12 max-md:text-center">
          <h2 className="text-slate-900 text-3xl font-bold mb-4 md:!leading-[45px] leading-[40px]">Discover Our Exclusive Features</h2>
          <p className="text-slate-600 text-[15px] leading-relaxed">Unlock a world of possibilities with our exclusive features. Explore how our unique offerings can transform your journey and empower you to achieve more.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
          <div className="bg-white border border-gray-200 p-5 rounded-2xl">
            <div className="flex items-center gap-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[52px] h-[52px] bg-blue-50 fill-blue-700 p-3 rounded-lg shrink-0" viewBox="0 0 100 100">
              ...
              <div>
                <h3 className="text-slate-900 text-lg font-semibold">Customization</h3>
                <p className="text-[13px] text-slate-600 mt-1">Fits your brand needs</p>
              </div>
            </div>
            <hr className="border-gray-200 my-6" />
            <div>
              <p className="text-slate-600 text-[15px] leading-relaxed">Easily tailor every aspect of the platform to suit your business needs. From design tweaks to functional preferences and operate.</p>
            </div>
          </div>

          <div className="bg-white border border-gray-200 p-5 rounded-2xl">
            <div className="flex items-center gap-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[52px] h-[52px] bg-green-50 text-green-700 p-3 rounded-lg shrink-0" viewBox="0 0 682.667 682.667">
                <defs>
              ...
              <div>
                <h3 className="text-slate-900 text-lg font-semibold">Security</h3>
                <p className="text-[13px] text-slate-600 mt-1">Enterprise-level data security</p>
              </div>
            </div>
            <hr className="border-gray-200 my-6" />
            <div>
              <p className="text-slate-600 text-[15px] leading-relaxed">Your privacy is our top priority. We implement industry-standard encryption and real-time threat detection to keep your data safe.</p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[52px] h-[52px] bg-purple-50 fill-purple-700 p-3 rounded-lg shrink-0" fillRule="evenodd" viewBox="0 0 24 24">
                <g transform="matrix(1.06 0 0 1.06 -.72 -.72)">
                  ...
                  <circle cx="10.25" cy="5" r=".75" data-original="#000000" />
                  <path d="M22.75 13V4.5a3.25 3.25 0 0 0-3.25-3.25h-15A3.25 3.25 0 0 0 1.25 4.5v15a3.25 3.25 0 0 0 3.25 3.25H12a.75.75 0 0 0 0-1.5H4.5a1.75 1.75 0 0 1-1.75-1.75v-15c0-.967.783-1.75 1.75-1.75h15c.967 0 1.75.783 1.75 1.75V13a.75.75 0 0 0 1.5 0z" data-original="#000000" />
                  <path d="M22 7.25H2a.75.75 0 0 0 0 1.5h20a.75.75 0 0 0 0-1.5zm-.543 14.32-2.101-3a.75.75 0 1 0-1.228.86l2.1 3a.75.75 0 0 0 1.229-.86z" data-original="#000000" />
                  <path d="m22.067 16.084-6.47-3.733a1.367 1.367 0 0 0-2.027 1.419l1.295 7.357a1.365 1.365 0 0 0 2.428.594l1.754-2.286 2.748-.866a1.366 1.366 0 0 0 .272-2.485zm-1.015 1.146-2.682.846a.742.742 0 0 0-.369.258l-1.712 2.232-1.192-6.772z" data-original="#000000" />
                </g>
              </svg>
              <div>
                <h3 className="text-slate-900 text-lg font-semibold">User-Friendly Interface</h3>
                <p className="text-[13px] text-slate-600 mt-1">Streamlined for productivity</p>
              </div>
            </div>
            <hr className="border-gray-200 my-6" />
            <div>
              <p className="text-slate-600 text-[15px] leading-relaxed">Navigate with ease using our intuitive interface designed for efficiency. Whether you're a beginner or expert.</p>
            </div>
          </div>

          <div className="bg-white border border-gray-200 p-5 rounded-2xl">
            <div className="flex items-center gap-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[52px] h-[52px] bg-orange-50 fill-orange-700 p-3 rounded-lg shrink-0" viewBox="0 0 512 512">
              ...
              <div>
                <h3 className="text-slate-900 text-lg font-semibold">Performance</h3>
                <p className="text-[13px] text-slate-600 mt-1">Fast and dependable</p>
              </div>
            </div>
            <hr className="border-gray-200 my-6" />
            <div>
              <p className="text-slate-600 text-[15px] leading-relaxed">Experience lightning-fast load times and seamless performance. Our system is built to deliver results without lag or disruption.</p>
            </div>
          </div>

          <div className="bg-white border border-gray-200 p-5 rounded-2xl">
            <div className="flex items-center gap-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[52px] h-[52px] bg-pink-50 text-pink-700 p-3 rounded-lg shrink-0" viewBox="0 0 682.667 682.667">
                <defs>
            ...
            <hr className="border-gray-200 my-6" />
            <div>
              <p className="text-slate-600 text-[15px] leading-relaxed">Whether you're a startup or enterprise. Add users, features, or capabilities without disrupting performance.</p>
            </div>
          </div>

          <div className="bg-white border border-gray-200 p-5 rounded-2xl">
            <div className="flex items-center gap-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-[52px] h-[52px] bg-blue-50 fill-blue-700 p-3 rounded-lg shrink-0" viewBox="0 0 512 512">
              ...
              <div>
                <h3 className="text-slate-900 text-lg font-semibold">24/7 Support</h3>
                <p className="text-[13px] text-slate-600 mt-1">Help is always within reach</p>
              </div>
            </div>
            <hr className="border-gray-200 my-6" />
            <div>
              <p className="text-slate-600 text-[15px] leading-relaxed">Our expert support team is available around the clock to assist you. we’re here to ensure your experience remains smooth.</p>
            </div>
          </div>
        </div>
      </div>
